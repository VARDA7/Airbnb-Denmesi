...
// 41.satır big problem
// Not: eğer img link src={'http://localhost:4000/uploads/' uploads kısmını kaldırırsak ressim linki ekleyemiyoruz kaldırmassak da bilgisayardan resim ekliyemiyoruz sayafa uzantısını iki kere tekrarlıyor nedeni bulamasım hala !!!
// chrome nin onemi :   https://reactjs.org/link/react-devtools linktekileri indirip kurulum yaparsanız tarayıcımız geliştirme modunda oldugumuzu anlıp bize kolaylıklar sağlıyor eklentiler vs vs gibi şeyler barındırıyor.(daha denemedim :D)
